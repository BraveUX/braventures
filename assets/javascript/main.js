...
(function animateVentures() {
    var incrementalStagger = 0.5;

    loop(document.querySelectorAll('.venture'), function (elem) {
        ...
        }, 0).from(elem.querySelector('.venture__logo'), 2, {
            autoAlpha: 0,
            y: 50,
            ease: Elastic.easeOut.config(1, 0.5)
        }, 0).staggerFrom(elem.querySelector('.venture__copy').children, 2, {
            autoAlpha: 0,
            y: '+=20',
        ...
        if (!elem.classList.contains('ftb')) {
            tl.staggerFrom(elem.querySelectorAll('.venture__preview'), 1.25, {
                autoAlpha: 0,
                y: 30,
            ...
            tl.staggerFrom(elem.querySelectorAll('.venture__preview'), 0.5, {
                rotationX: '90deg',
...
(function scrollTop() {
    ...
    loop(document.querySelectorAll('.header__logo, .header__title'), function (elem) {
